...
-keep public class com.replayx.app.ui.SecureWebViewActivity { public *; }
-keep public class com.replayx.app.ui.OptimizationActivity { public *; }
-keep public class com.replayx.app.ui.ExpiredActivity { public *; }
